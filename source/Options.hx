...
class CameraMoving extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return "Camera Singing Move: < " + (FlxG.save.data.cameramove ? "Enabled" : "Disabled") + " >";
	}
}
...
class LockWeeksOption extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.hiveUnlocked = false;
		StoryMenuState.weekUnlocked = [true, false];
		confirm = false;
		trace('Weeks Locked');
		display = updateDisplay();
		return true;
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.cameramove = null;
