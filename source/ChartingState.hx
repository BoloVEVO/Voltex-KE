	...
	**/
	...
	override function create()
	{
		...
		if (PlayState.SONG != null)
		{
			...
			{
				var diff:String = ["-novice", "-advanced", "-exhaust", "-maximum", "-heavenly"][PlayState.storyDifficulty];
	...
	{
		var difficultyArray:Array<String> = ["-novice", "-advanced", "-exhaust", "-maximum", "-heavenly"];

		var finaleArray:Array<String> = ["-heavenly"];
