...
class StoryMenuState extends MusicBeatState
{
	...
	{
		return [['made-in-love', 'sayonara-planet-wars', 'i'], ['fin4le']];
	}
	...
	override function create()
	{
		...
		if (PlayState.inDaPlay)
		{
			...
			PlayState.boyfriend.kill();
			PlayState.gf.destroy();
			PlayState.dad.kill();
			PlayState.boyfriend.destroy();
			PlayState.gf.destroy();
			PlayState.dad.destroy();
			PlayState.Stage.destroy();
		}
		...
		scoreText.setFormat(Paths.font("aironec.ttf"), 32);

		txtWeekTitle = new FlxText(FlxG.width * 0.7, 10, 0, "", 32);
		txtWeekTitle.setFormat(Paths.font("aironec.ttf"), 32, FlxColor.WHITE, RIGHT);
		txtWeekTitle.alpha = 0.7;

		var rankText:FlxText = new FlxText(0, 10);
		rankText.text = 'RANK: GREAT';
		rankText.setFormat(Paths.font("aironec.ttf"), 32);
		...
		txtTracklist = new FlxText(FlxG.width * 0.05, bgSprite.y + 415, 0, "Tracks", 32);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			PlayState.SONG = Song.conversionChecks(Song.loadFromJson(PlayState.storyPlaylist[0],
				'-' + CoolUtil.difficultyFromInt(curDifficulty, curWeek == 1).toLowerCase()));
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		var diffSpr:FlxGraphic = Paths.image('menudifficulties/' + CoolUtil.difficultyFromInt(curDifficulty, curWeek == 1).toLowerCase());
		if (sprDifficulty.graphic != diffSpr)
		{
			sprDifficulty.loadGraphic(diffSpr);
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if (curWeek == 1)
		{
			sprDifficulty.loadGraphic(Paths.image('menudifficulties/heavenly'));
			curDifficulty = 0;
		}
		...
		{
			bgSprite.loadGraphic(Paths.image('menubackgrounds/menuWeek_' + curWeek));
		}
