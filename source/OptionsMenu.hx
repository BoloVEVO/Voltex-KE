...
class OptionsMenu extends FlxSubState
{
	...
	override function create()
	{
		options = [
			new OptionCata(50, 40, "Gameplay", [
				...
				new HitSoundOption("Toggle hit sound when you press a key."),
				new HitSoundVolume("Set your hit sound volume."),
				...
				new CameraMoving("Toggle camera moving when a character sings."),
	...
	public function selectOption(option:Option)
	{
		...
		if (!isInCat)
		{
			...
			if ((selectedOptionIndex == 11 || selectedOptionIndex == 12) && FlxG.save.data.optimize && selectedCatIndex == 0)
			{
	...
	override function update(elapsed:Float)
	{
		...
		accept = (FlxG.keys.justPressed.ENTER || (gamepad != null ? gamepad.justPressed.A : false)) && !MusicBeatState.switchingState;
		right = (FlxG.keys.justPressed.RIGHT || (gamepad != null ? gamepad.justPressed.DPAD_RIGHT : false))
			&& !MusicBeatState.switchingState;
		left = (FlxG.keys.justPressed.LEFT || (gamepad != null ? gamepad.justPressed.DPAD_LEFT : false)) && !MusicBeatState.switchingState;
		up = (FlxG.keys.justPressed.UP || (gamepad != null ? gamepad.justPressed.DPAD_UP : false)) && !MusicBeatState.switchingState;
		down = (FlxG.keys.justPressed.DOWN || (gamepad != null ? gamepad.justPressed.DPAD_DOWN : false)) && !MusicBeatState.switchingState;

		any = (FlxG.keys.justPressed.ANY || (gamepad != null ? gamepad.justPressed.ANY : false)) && !MusicBeatState.switchingState;
		escape = (FlxG.keys.justPressed.ESCAPE || (gamepad != null ? gamepad.justPressed.B : false)) && !MusicBeatState.switchingState;
